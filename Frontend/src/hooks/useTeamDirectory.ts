...
export function useTeamDirectory(params: { page?: number; limit?: number; search?: string; department?: string; includeAllRoles?: boolean; role?: 'ADMIN' | 'TEAM_MEMBER' | 'AREA_OWNER' }) {
