// Added Manage departments page with tabs for Departments overview, Team Member management, and Apply/Impact preview. Departments are fixed as per requirements. Team members can be assigned/unassigned with search and confirmation flows. Apply/Impact tab shows real time mapping of departments to active/inactive members and initiators. Used React Query for data fetching and mutations, with loading and error states handled gracefully throughout the UI.
...
export const ManageDepartmentsPage: React.FC = () => {
  ...
  // This is a logical removal: deactivate the user (soft delete) so row is preserved.
