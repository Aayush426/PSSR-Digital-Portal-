...
/**
 * Minimal AREA_OWNER dashboard.
 *
 * Area-owner workflows will eventually include area-scoped reviews, approvals,
 * and handover evidence. The first release keeps the landing screen focused on
 * authenticated identity so role routing can be validated cleanly.
 */
